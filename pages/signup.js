...
export default function Registrieren({csrf}) {
  ...
  const handleSubmit = async (event) => {
    ...
    const city = addressNotFoundChooseInput ? formCity : selectedAddress?.address?.municipality || selectedAddress?.address?.city || selectedAddress?.address?.town || selectedAddress?.address?.village
